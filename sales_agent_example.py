...
import asyncio
from system_prompt import professional_sales_agent_instructions, engaging_sales_agent_instructions, busy_sales_agent_instructions
...
async def main():
    ...
    print(
        "------------------Streaming output from sales_agent1-----------------------------------"
    )
